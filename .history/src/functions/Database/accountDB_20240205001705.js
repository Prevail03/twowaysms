                      ...
                      sql.connect(config, function (err, connection) {
                        ...
                        checkIfExistsRequestSysUsers.query(checkIfExistsQuerySysUsers, function (checkErrSysUsers, checkResultsSysUsers) {
                          ...
                          if (checkResultsSysUsers.recordset.length > 0) {
                            ...
                            const memberEmail = checkResultsSysUsers.recordset[0].m_email;
                            const memberName = checkResultsSysUsers.recordset[0].m_name;
                            const schemeCode = checkResultsSysUsers.recordset[0].m_scheme_code;
