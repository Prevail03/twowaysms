        ...
        if (passwordResults.recordset.length > 0) {
          ...
          accountsClient.post("https://api.octagonafrica.com/v1/loginwithPhone", args, function (data, response) {
            if ([200].includes(response.statusCode)) {
              ...
              console.log(args);
              getClaimStatus.post("https://api.octagonafrica.com/v1/claims/listclaims", args, function (data, response) {
                if (response.statusCode === 200) {
                  ...
                  claim_data.forEach((claim, index) => {
                      ...
                      finalMessage += ` as at date ${claim.as_at_date}. The amount you are claiming is ${claim.amount}.\n`;
                  });
