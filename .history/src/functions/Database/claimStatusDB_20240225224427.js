              ...
              getClaimStatus.get("https://api.octagonafrica.com/v1/claims/getclaims", args, function (data, response) {
                if ([200].includes(response.statusCode)) {
                  ...
                  sms.sendPremium({
                    to: sender,
                    from: '24123',
                    message: 'Dear '+ member_name +', You are yet to initiate a benefits withdrawal claim.Please use our access channels(Octagon Africa App, Member Portal and Two-Way SMS) to make your claim. T',
                    bulkSMSMode: 0,
                    keyword: 'pension',
                    linkId: LinkID
                  });
