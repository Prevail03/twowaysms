...
function handleProductsAndServices(textMessage, sender, messagingStep, sms, config, textIDAT, LinkID, products){
  switch (parseInt(messagingStep)) {
    ...
    case 8:
      ...
      const textModeOfPayment = textMessage;
      const textIDATModeOfPayment = textIDAT;
      updateMethodOfPayment(sender, statusModeOfPayment, phoneNumberModeOfPayment, messagingStepModeOfPayment, textModeOfPayment, config, textIDATModeOfPayment, textIDAT, sms, LinkID);
